...
- Generate the language specific 'storyliner.mo' dictionary.
...
APP_NAME = 'storyliner'
PO_PATH = '../i18n/de.po'
MO_PATH = '../i18n/locale/de/LC_MESSAGES/storyliner.mo'
MO_COPY = '../src/locale/de/LC_MESSAGES/storyliner.mo'
