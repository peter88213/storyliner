"""Provide a converter class for storyliner universal import and export.
...
class SlDocImporter:
    ...
    Support storyliner projects and most of the File subclasses 
    ...
    def run(self, sourcePath, **kwargs):
        ...
        try:
            ...
            # A new storyliner project might be required.
            source, target = self.newProjectFactory.make_file_objects(sourcePath, **kwargs)
            if os.path.isfile(target.filePath):
                # do not overwrite an existing storyliner project with a non-tagged document
            ...
            # Try to update an existing storyliner project.
